...
import 'package:whatsapp/components/calls_component.dart';
import 'package:whatsapp/components/chats_component.dart';
import 'package:whatsapp/components/status_component.dart';
import 'package:whatsapp/res/globals.dart';
      ...
      return MaterialApp(
        ...
        theme: ThemeData.light().copyWith(
          colorScheme: ColorScheme.fromSwatch(
            primarySwatch: buildMaterialColor(const Color(0xff74B49B)),
          ),
        ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(child: Text( "Chats",style: TextStyle(fontSize: 17),),),
        ...
        tabBar: CupertinoTabBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: Icon(CupertinoIcons.at_circle_fill),
              label: "Status",
            ),
            BottomNavigationBarItem(
